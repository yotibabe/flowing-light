...
<div id="wechat-modal" class="fixed inset-0 z-[100] hidden items-center justify-center p-4">
    ...
    <div id="wechat-modal-content" class="relative bg-white p-8 shadow-2xl scale-95 opacity-0 transition-all duration-300 max-w-[320px] w-full mx-auto flex flex-col items-center rounded-2xl">
        ...
        <!-- Profile info above QR (Exact match to screenshot: Blue square with YO) -->
        <div class="flex items-center gap-3 self-start ml-2 mb-2">
            <div class="w-12 h-12 bg-[#3A4A9F] rounded-lg flex items-center justify-center text-white font-sans text-xl font-medium tracking-wider">
                YO
            </div>
            <div class="flex flex-col">
                <span class="font-bold text-sm text-gray-900">Yoti</span>
                <span class="text-[11px] text-gray-400 mt-0.5">广东 深圳</span>
            </div>
        </div>
        
        <div class="w-full aspect-square bg-white mb-6 flex justify-center items-center">
            <img src="assets/wechat-qr-yoti.jpg" alt="WeChat QR Code" class="w-[90%] h-[90%] object-contain">
        </div>
